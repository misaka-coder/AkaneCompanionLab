...
def _apply_settings(s: Settings) -> None:
    ...
    FINANCE_PUBLIC_MARKET_YAHOO_SERIES_TTL_SECONDS = max(1.0, min(86400.0, float(s.FINANCE_PUBLIC_MARKET_YAHOO_SERIES_TTL_SECONDS)))
    FINANCE_PUBLIC_MARKET_YAHOO_QUOTE_TTL_SECONDS = max(1.0, min(86400.0, float(s.FINANCE_PUBLIC_MARKET_YAHOO_QUOTE_TTL_SECONDS)))
    FINANCE_PUBLIC_MARKET_AKSHARE_SERIES_TTL_SECONDS = max(1.0, min(86400.0, float(s.FINANCE_PUBLIC_MARKET_AKSHARE_SERIES_TTL_SECONDS)))
    FINANCE_PUBLIC_MARKET_AKSHARE_QUOTE_TTL_SECONDS = max(1.0, min(86400.0, float(s.FINANCE_PUBLIC_MARKET_AKSHARE_QUOTE_TTL_SECONDS)))
    FINANCE_PUBLIC_MARKET_FAILURE_TTL_SECONDS = max(1.0, min(86400.0, float(s.FINANCE_PUBLIC_MARKET_FAILURE_TTL_SECONDS)))
