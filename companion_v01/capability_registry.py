...
READ_WORKSPACE_TOOL_SPEC = CapabilityToolSpec(
    ...
    input_schema={
        ...
        "properties": {
            ...
            "cursor": {"type": "string", "description": "Opaque continuation cursor from a previous read_workspace page. Pass only the cursor to read the next page of the same files; do not combine it with targets/max_chars."},
        },
        "required": [],
    },
    risk="low",
