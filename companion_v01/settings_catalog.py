...
_SPECS: tuple[SettingSpec, ...] = (
    ...
    # Embedding / 向量记忆
    _s("EMBEDDING_PROVIDER", _EMB, SCOPE_RESTART_CLIENT, "提供者：auto/huggingface/remote/jina/hashed"),
    _s("EMBEDDING_MODEL_NAME", _EMB, SCOPE_RESTART_CLIENT, "模型名或 HuggingFace 本地模型目录"),
    _s("EMBEDDING_BASE_URL", _EMB, SCOPE_RESTART_CLIENT, "远程 Embedding API 地址"),
    _s("EMBEDDING_API_KEY", _EMB, SCOPE_RESTART_CLIENT, "远程 Embedding API Key", sensitive=True),
    _s("EMBEDDING_DIMENSION", _EMB, SCOPE_RESTART_CLIENT, "远程 Embedding 输出维度"),
    _s("EMBEDDING_TIMEOUT_SECONDS", _EMB, SCOPE_RESTART_CLIENT, "远程 Embedding 请求超时秒数"),
    ...
    _s(
        ...
        _QQ,
        SCOPE_RUNTIME,
        "未触发 Bot 的群消息记忆策略：all/denylist/off（旧 allowlist 自动迁移为 all）",
    ),
    _s(
