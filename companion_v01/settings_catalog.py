...
_MIGRATING_FINANCE_KEYS = {
    "FINANCE_ASSISTANT_ENABLED",
    "FINANCE_DEFAULT_MODE",
    "FINANCE_TOOL_ROUND_BUDGET",
    "FINANCE_TOOL_ROUND_HARD_LIMIT",
    "FINANCE_ANALYSIS_MAX_ATTEMPTS",
    "FINANCE_ANALYSIS_RETRY_BACKOFF_SECONDS",
    "FINANCE_MARKET_PROVIDER",
    "FINANCE_PUBLIC_MARKET_YAHOO_ENABLED",
    "FINANCE_PUBLIC_MARKET_AKSHARE_ENABLED",
    "FINANCE_PUBLIC_MARKET_TIMEOUT_SECONDS",
    "FINANCE_PUBLIC_MARKET_CACHE_MAX_ENTRIES",
    "FINANCE_PUBLIC_MARKET_YAHOO_SERIES_TTL_SECONDS",
    "FINANCE_PUBLIC_MARKET_YAHOO_QUOTE_TTL_SECONDS",
    "FINANCE_PUBLIC_MARKET_AKSHARE_SERIES_TTL_SECONDS",
    "FINANCE_PUBLIC_MARKET_AKSHARE_QUOTE_TTL_SECONDS",
    "FINANCE_PUBLIC_MARKET_FAILURE_TTL_SECONDS",
    "FINANCE_PUBLIC_NEWS_ENABLED",
    "FINANCE_PUBLIC_NEWS_POLL_INTERVAL_SECONDS",
    "FINANCE_PUBLIC_NEWS_TIMEOUT_SECONDS",
    "FINANCE_PUBLIC_NEWS_REQUIRE_LLM_MODERATION",
    "FINANCE_PUBLIC_NEWS_MODEL_ANALYSIS_ENABLED",
    "FINANCE_EVENT_DB_PATH",
    "EMQUANT_BRIDGE_URL",
    "EMQUANT_BRIDGE_TOKEN",
    "EMQUANT_HTTP_TIMEOUT_SECONDS",
    "FINANCE_EVENT_INGESTION_ENABLED",
    "FINANCE_EVENT_POLL_INTERVAL_SECONDS",
    "FINANCE_EVENT_POLL_BATCH_SIZE",
    "FINANCE_EVENT_RECOVERY_MAX_AGE_SECONDS",
    "FINANCE_PUSH_GOVERNANCE_ENABLED",
    "FINANCE_PUSH_CLUSTER_COALESCE_SECONDS",
    "FINANCE_PUSH_CLUSTER_MAX_WAIT_SECONDS",
    "FINANCE_PUSH_DIGEST_ENABLED",
    "FINANCE_PUSH_DIGEST_INTERVAL_SECONDS",
    "FINANCE_PUSH_MIN_INTERVAL_SECONDS",
    "FINANCE_PUSH_RATE_WINDOW_SECONDS",
    "FINANCE_PUSH_MAX_PER_WINDOW",
    "FINANCE_PUSH_QUIET_HOURS_ENABLED",
    "FINANCE_PUSH_QUIET_START",
    "FINANCE_PUSH_QUIET_END",
    "QQ_FINANCE_MODE_COMMANDS_ENABLED",
    "QQ_FINANCE_PUSH_ENABLED",
}
EXCLUDED_KEYS: frozenset[str] = frozenset({"AKANE_INSTANCE_ID", *_MIGRATING_FINANCE_KEYS})
...
_SPECS: tuple[SettingSpec, ...] = (
    ...
    _s("IMAGE_GENERATION_ENABLED", _VIS, SCOPE_RESTART_CLIENT, "云端图片生成/编辑总开关"),
    _s("IMAGE_GENERATION_BASE_URL", _VIS, SCOPE_RESTART_CLIENT, "图片生成 OpenAI 兼容 base_url"),
    _s("IMAGE_GENERATION_API_KEY", _VIS, SCOPE_RESTART_CLIENT, "图片生成 API Key", sensitive=True),
    _s("IMAGE_GENERATION_MODEL", _VIS, SCOPE_RESTART_CLIENT, "图片生成模型名"),
    _s("IMAGE_GENERATION_TIMEOUT_SECONDS", _VIS, SCOPE_RESTART_CLIENT, "图片生成总超时（秒）"),
    _s("IMAGE_GENERATION_MAX_INPUT_IMAGES", _VIS, SCOPE_RESTART_CLIENT, "单次最大参考图数量"),
    _s("IMAGE_GENERATION_MAX_OUTPUT_IMAGES", _VIS, SCOPE_RESTART_CLIENT, "单次最大生成图数量"),
    _s("IMAGE_GENERATION_MAX_IMAGE_BYTES", _VIS, SCOPE_RESTART_CLIENT, "单张参考图最大字节数"),
    _s("IMAGE_GENERATION_MAX_TOTAL_INPUT_BYTES", _VIS, SCOPE_RESTART_CLIENT, "参考图总字节上限"),
    _s("IMAGE_GENERATION_MAX_OUTPUT_BYTES", _VIS, SCOPE_RESTART_CLIENT, "单张生成图最大字节数"),
    _s("COVER_SONG_ENABLED", _TTS, SCOPE_RESTART_CLIENT, "本地 RVC 自动翻唱总开关"),
    _s("RVC_WEBUI_BASE_URL", _TTS, SCOPE_RESTART_CLIENT, "RVC WebUI 本地地址"),
    _s("RVC_ROOT_DIR", _TTS, SCOPE_RESTART_CLIENT, "RVC 安装目录（用于模型缓存指纹）"),
    _s("RVC_DEFAULT_MODEL", _TTS, SCOPE_RESTART_CLIENT, "RVC 默认翻唱音色模型"),
    _s("COVER_SONG_SEPARATION_MODEL", _TTS, SCOPE_RESTART_CLIENT, "翻唱主唱/伴奏分离模型"),
    _s("COVER_SONG_DEFAULT_OUTPUT_FORMAT", _TTS, SCOPE_RESTART_CLIENT, "翻唱默认输出格式"),
    _s("COVER_SONG_DEFAULT_DELIVERY", _TTS, SCOPE_RESTART_CLIENT, "翻唱默认交付方式"),
