...
class CapabilityApprovalStore:
    ...
    def get_request(self, *, profile_user_id: str, request_id: str, session_id: str | None = None) -> dict[str, Any]:
        ...
        with self._lock:
            ...
            if (not entry or str(entry.get("_profileUserId") or "") != str(profile_user_id or "")
                    or (session_id is not None and str(entry.get("_sessionId") or "") != str(session_id))):
