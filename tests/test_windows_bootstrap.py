...
class WindowsBootstrapContractTests(unittest.TestCase):
    ...
    def test_bootstrap_prepares_core_and_degrades_auto_mode_to_web(self) -> None:
        ...
        self.assertIn("Assert-CoreSourceDependencies", source)
        self.assertIn("capcore source checkout was not found", source)
        self.assertIn("capcore-adapter-mcp source checkout was not found", source)
        ...
        self.assertIn("promptpack-core source checkout was not found", source)
        self.assertIn("import capcore", source)
        self.assertIn(
            "import capcore, capcore_adapter_mcp, capcore_adapter_python, capcore_adapter_speech, capcore_adapter_comfyui, capcore_provider_native_tools, capcore_provider_openai, charpack_core, promptpack_core",
            source,
        )
