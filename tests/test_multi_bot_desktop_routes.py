...
class _Runtime:
    def __init__(self, root: Path, bot_id: str, display_name: str) -> None:
        ...
        self.session_work_queue = None
        self.plugin_conversation_refs = PluginConversationReferenceAuthority(root / "conversation.key", instance_id=bot_id)
        ...
        self.plugin_agent_event_router = HostTurnRequests(self.plugin_conversation_refs.resolve)
