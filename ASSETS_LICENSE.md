...
## Bundled Demo Scenes and UI Art

The public export includes minimal starter illustrations for the default scene and control center:

| Field | Value |
| --- | --- |
| Path | `web/assets/scenes/家/*.png`, `desktop_pet_next/src/assets/control-center-lab/heroes/*.png` |
| Title | Starter scene backgrounds (Living Room day/night) & hero banners |
| Author | Akane Companion Lab contributors |
| Source | Original AI-generated artwork created for AkaneCompanionLab |
| License | Bundled-use only (same terms as akane_v1 demo character above) |
| Changes | Curated for UI demonstration |
| Redistribution | Allowed only as part of AkaneCompanionLab |
