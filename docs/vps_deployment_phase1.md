...
- `FastAPI` 应用入口在 [launch_akane_memory_v01.py](/f:/Akane/AkaneCompanionLab/launch_akane_memory_v01.py)
- 关系型存储使用本地 `SQLite`，见 [store.py](/f:/Akane/AkaneCompanionLab/companion_v01/store.py)
- 向量索引使用本地持久化 `ChromaDB`，见 [vector_store.py](/f:/Akane/AkaneCompanionLab/companion_v01/vector_store.py)
- 静态前端和资源也由同一应用提供，见 [app.py](/f:/Akane/AkaneCompanionLab/companion_v01/app.py)
...
- 只安装 [requirements.txt](/f:/Akane/AkaneCompanionLab/requirements.txt)
- 不安装 [requirements-ml.txt](/f:/Akane/AkaneCompanionLab/requirements-ml.txt)
...
- 安装 [requirements.txt](/f:/Akane/AkaneCompanionLab/requirements.txt)
- 再安装 [requirements-ml.txt](/f:/Akane/AkaneCompanionLab/requirements-ml.txt)
...
- `systemd` 模板：
  [akane.service.example](/f:/Akane/AkaneCompanionLab/deploy/systemd/akane.service.example)
- `nginx` 模板：
  [akane.nginx.conf.example](/f:/Akane/AkaneCompanionLab/deploy/nginx/akane.nginx.conf.example)
