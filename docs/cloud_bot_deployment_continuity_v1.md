...
python scripts/prepare_akane_cloud_bundle.py `
  --source-root C:\Akane\AkaneData `
  --output-dir C:\Akane\CloudBundles\personal `
  ...
  --port 10001 `
  --archive C:\Akane\CloudBundles\personal.tar.gz
```
...
python scripts/verify_akane_cloud_bundle.py `
  --bundle-dir C:\Akane\CloudBundles\personal
```
