...
- [companion_v01/engine.py](/f:/Akane/AkaneCompanionLab/companion_v01/engine.py)
  - 统一调度记忆、工具、礼物、视觉、资源投影。
- [companion_v01/store.py](/f:/Akane/AkaneCompanionLab/companion_v01/store.py)
  - 会话、消息、提醒、礼物、视觉缓存等持久层。
- [companion_v01/resource_manifest.py](/f:/Akane/AkaneCompanionLab/companion_v01/resource_manifest.py)
  - 资源协议、运行时 manifest、视觉对象解析。
- [companion_v01/gift_system](/f:/Akane/AkaneCompanionLab/companion_v01/gift_system)
  - 礼物仓储、处理器、投影、决策上下文。
- [companion_v01/vision_service.py](/f:/Akane/AkaneCompanionLab/companion_v01/vision_service.py)
  - 场景 / 礼物 / 服装观察卡。
- [companion_v01/tool_runtime.py](/f:/Akane/AkaneCompanionLab/companion_v01/tool_runtime.py)
  - 工具协议与 handler 体系。
- [companion_v01/memory_compaction_service.py](/f:/Akane/AkaneCompanionLab/companion_v01/memory_compaction_service.py)
  - 记忆压缩与摘要循环。
...
- [companion_v01/persona_profiles.toml](/f:/Akane/AkaneCompanionLab/companion_v01/persona_profiles.toml)
  - 人设、说话边界、输出风格、角色示例。
...
- [companion_v01/prompt_builder.py](/f:/Akane/AkaneCompanionLab/companion_v01/prompt_builder.py)
  - 结构是通用的，但当前仍然紧贴某个 persona 实例。
- [companion_v01/persona_config.py](/f:/Akane/AkaneCompanionLab/companion_v01/persona_config.py)
  - 仍然像“默认角色入口”，还不是真正的角色加载协议。
- [web/app.js](/f:/Akane/AkaneCompanionLab/web/app.js) / [web/index.html](/f:/Akane/AkaneCompanionLab/web/index.html)
  - 已经有通用壳，但仍有 Akane 名称和单角色默认体验。
- [companion_v01/app.py](/f:/Akane/AkaneCompanionLab/companion_v01/app.py)
