...
|--------|-------|----------|
| **Bridged** | 46 unique action IDs / 55 surface entries | Real settings command, Tauri invoke, Tauri window API, or dedicated backend route |
| **Client-handled** | 4 | Local UI toggle, `refresh:false`, no backend/Tauri boundary |
